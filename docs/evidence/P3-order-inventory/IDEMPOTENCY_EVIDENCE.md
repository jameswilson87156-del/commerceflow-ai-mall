...
| --- | --- | --- |
| `p3-demo-primary`, SKU `10001`, quantity `1` | created `CF1785047035057` | one order, item, and movement |
| same key and same body | returned `CF1785047035057` | no second order, item, stock deduction, or movement |
...
The script asserted that exactly three successful API requests created rows. The final real list contained three orders: `CF1785047035057`, `CF1785047035529`, and `CF1785047035633`.
